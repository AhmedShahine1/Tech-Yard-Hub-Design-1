...
$(document).ready(function () {
  ...
  // Trigger the animation when the page loads if the section is already in the viewport
  animateOnScroll();
});
...
$(document).ready(function () {
  ...
  function animateOnScroll() {
    ...
    if (isElementInViewport($newsSection[0])) {
      ...
      // Animate each news card with slide in and fade effect
  ...
  // Trigger the animation if the section is already in the viewport on page load
  animateOnScroll();
});
